...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.5ba64d6a-1270-4340-9a49-1ad9a06213dd"),
    analysis_2_PASC_case_cohort_2b=Input(rid="ri.foundry.main.dataset.e3640a26-eac1-43b7-b012-261f6dbbd2f3")
)
def analysis_2_PASC_case_cohort_2b_summary_copied(analysis_2_PASC_case_cohort_2b):
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.a091e820-a146-43c6-a6de-26dbb09ff37b"),
    analysis_2b_xgboost=Input(rid="ri.foundry.main.dataset.40938b04-d7e0-4669-9b4e-57d4be39e92a")
)
def analysis_2b_xgboost_feature_importance_copied(analysis_2b_xgboost):
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.79027133-5b90-4a76-b41a-578a8173acfb"),
    analysis_1_cohort=Input(rid="ri.foundry.main.dataset.cd475047-2ef9-415c-8812-8336515c5c1f")
)
def simplified_shap_plot_analysis_1_copied(analysis_1_cohort):
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.3b2c0446-95a9-4c07-90f5-f49343ae7b50"),
    analysis_1_cohort=Input(rid="ri.foundry.main.dataset.cd475047-2ef9-415c-8812-8336515c5c1f")
)
def simplified_shap_plot_analysis_1_copied_1(analysis_1_cohort):
