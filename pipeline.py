...
def analysis_1_COVID_positive_control_pre_matching(analysis_1_COVID_positive_control, analysis_1_PASC_case):
    df1 = analysis_1_COVID_positive_control.select('person_id', 'observation_period_post_covid', 'data_partner_id', 'age_at_covid', 'index_date', 'long_covid', 'log_number_of_visits_per_month_before_index_date')
    df2 = analysis_1_PASC_case.select('person_id', 'observation_period_post_covid', 'data_partner_id', 'age_at_covid', 'index_date', 'long_covid', 'log_number_of_visits_per_month_before_index_date')
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.0d8ec94d-94c4-48f2-bb1f-24cd41ed2e7c"),
    PHASTR_Logic_Liaison_Covid_19_Patient_Summary_Facts_Table_LDS_with_computable_phenotype=Input(rid="ri.foundry.main.dataset.d7394fbc-bc61-4bc7-953f-7b6c7b1c07ea"),
    visit_occurrence=Input(rid="ri.foundry.main.dataset.911d0bb2-c56e-46bd-af4f-8d9611183bb7")
)
def analysis_1_PASC_case_count(PHASTR_Logic_Liaison_Covid_19_Patient_Summary_Facts_Table_LDS_with_computable_phenotype, visit_occurrence):
    # COVID positive
    # Now we only have threshold 0.75, and would change the threshold after sensitivity analysis
    # COVID_first_poslab_or_diagnosis_date as index date
    df = PHASTR_Logic_Liaison_Covid_19_Patient_Summary_Facts_Table_LDS_with_computable_phenotype
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.ad3be3d5-d60e-4ba7-a41f-d7d0d88254ab"),
    analysis_1_cohort=Input(rid="ri.foundry.main.dataset.cd475047-2ef9-415c-8812-8336515c5c1f")
)
def analysis_1_xgboost_cv_1(analysis_1_cohort):
    df = analysis_1_cohort
    random.seed(2023)
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.8448dac7-9678-45df-8ecb-265f68438b49"),
    PHASTR_Logic_Liaison_Covid_19_Patient_Summary_Facts_Table_LDS_with_computable_phenotype=Input(rid="ri.foundry.main.dataset.d7394fbc-bc61-4bc7-953f-7b6c7b1c07ea")
)
def analysis_2_PASC_case_cohort_2a_count(PHASTR_Logic_Liaison_Covid_19_Patient_Summary_Facts_Table_LDS_with_computable_phenotype):
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.999d679e-97e2-4d29-ac14-97dc8ec94d85"),
    PHASTR_Logic_Liaison_Covid_19_Patient_Summary_Facts_Table_LDS_with_computable_phenotype=Input(rid="ri.foundry.main.dataset.d7394fbc-bc61-4bc7-953f-7b6c7b1c07ea")
)
...
def analysis_2a(analysis_2_PASC_case_cohort_2a, PHASTR_cci_COVID_positive):
    ...
    df = df.select('COVID_first_poslab_or_diagnosis_date', 'race_ethnicity', 'sex', 'age_at_covid', 'TUBERCULOSIS_before_or_day_of_covid_indicator', 'MILDLIVERDISEASE_before_or_day_of_covid_indicator', 'MODERATESEVERELIVERDISEASE_before_or_day_of_covid_indicator', 'THALASSEMIA_before_or_day_of_covid_indicator', 'RHEUMATOLOGICDISEASE_before_or_day_of_covid_indicator', 'DEMENTIA_before_or_day_of_covid_indicator', 'CONGESTIVEHEARTFAILURE_before_or_day_of_covid_indicator', 'SUBSTANCEUSEDISORDER_before_or_day_of_covid_indicator', 'DOWNSYNDROME_before_or_day_of_covid_indicator', 'KIDNEYDISEASE_before_or_day_of_covid_indicator', 'MALIGNANTCANCER_before_or_day_of_covid_indicator', 'DIABETESCOMPLICATED_before_or_day_of_covid_indicator', 'CEREBROVASCULARDISEASE_before_or_day_of_covid_indicator', 'PERIPHERALVASCULARDISEASE_before_or_day_of_covid_indicator', 'PREGNANCY_before_or_day_of_covid_indicator', 'HEARTFAILURE_before_or_day_of_covid_indicator', 'HEMIPLEGIAORPARAPLEGIA_before_or_day_of_covid_indicator', 'PSYCHOSIS_before_or_day_of_covid_indicator', 'CORONARYARTERYDISEASE_before_or_day_of_covid_indicator', 'SYSTEMICCORTICOSTEROIDS_before_or_day_of_covid_indicator', 'DEPRESSION_before_or_day_of_covid_indicator', 'METASTATICSOLIDTUMORCANCERS_before_or_day_of_covid_indicator', 'HIVINFECTION_before_or_day_of_covid_indicator', 'CHRONICLUNGDISEASE_before_or_day_of_covid_indicator', 'PEPTICULCER_before_or_day_of_covid_indicator', 'SICKLECELLDISEASE_before_or_day_of_covid_indicator', 'MYOCARDIALINFARCTION_before_or_day_of_covid_indicator', 'DIABETESUNCOMPLICATED_before_or_day_of_covid_indicator', 'CARDIOMYOPATHIES_before_or_day_of_covid_indicator', 'HYPERTENSION_before_or_day_of_covid_indicator', 'OTHERIMMUNOCOMPROMISED_before_or_day_of_covid_indicator', 'PULMONARYEMBOLISM_before_or_day_of_covid_indicator', 'TOBACCOSMOKER_before_or_day_of_covid_indicator', 'SOLIDORGANORBLOODSTEMCELLTRANSPLANT_before_or_day_of_covid_indicator', 'number_of_COVID_vaccine_doses_before_or_day_of_covid', 'COVID_associated_hospitalization_indicator', 'COVID_patient_death_indicator')
    for i in df.columns:
        if '_before_or_day_of_covid_indicator' in i:
            df = df.withColumnRenamed(i, i.replace('_before_or_day_of_covid_indicator', ''))
    ...
    df = df.drop('COVID_first_poslab_or_diagnosis_date', 'race_ethnicity', 'sex', 'number_of_visits_before_covid', 'observation_period_before_covid', 'age_at_covid')
    return df
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.8d94dbd9-9e04-495b-9138-e43fcbb0d62d"),
    analysis_2a=Input(rid="ri.foundry.main.dataset.dfd52b0d-1b4b-49d1-a420-0f3df44e0f8d")
)
def analysis_2a_xgboost_cv_1(analysis_2a):
    df = analysis_2a
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.439de1cd-fca6-4a21-ad62-36ea2ca3d0e9"),
    analysis_2b=Input(rid="ri.foundry.main.dataset.f251c730-78fb-4044-8c57-96c16e3c2011")
)
...
def coxph_python(coxph_prepare):
    df = coxph_prepare[['CCI', 'PASC', 'COVID_positive_control', 'number_of_COVID_vaccine_doses', 'duration', 'death']]
...
def simplified_shap_plot_analysis_2a(analysis_2a):
    ...
    shap.summary_plot(shap_values, X_test, plot_size=[50, 30], max_display = 50)
    plt.tight_layout()
    plt.show()
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.169a49b9-a20a-4423-814f-d4e9d7970887"),
    analysis_2a=Input(rid="ri.foundry.main.dataset.dfd52b0d-1b4b-49d1-a420-0f3df44e0f8d")
)
def simplified_shap_plot_analysis_2a_two_color(analysis_2a):
...
@transform_pandas(
    Output(rid="ri.vector.main.execute.375cce8e-f693-4516-a94f-5a6dc2bf9988"),
    analysis_2b=Input(rid="ri.foundry.main.dataset.f251c730-78fb-4044-8c57-96c16e3c2011")
)
def simplified_shap_plot_analysis_2b_two_color(analysis_2b):
