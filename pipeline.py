...
def analysis_1_COVID_positive_control(recover_release_visit_occurence, analysis_1_PASC_case, Logic_Liaison_Covid_19_Patient_Summary_Facts_Table_LDS_with_computable_phenotype):
