...
def coxph_python(coxph_prepare):
    df = coxph_prepare[['CCI', 'morbid_obesity', 'PASC', 'COVID_positive_control', 'number_of_COVID_vaccine_doses', 'number_of_visits_per_month_before_index_date', 'duration', 'death']]
